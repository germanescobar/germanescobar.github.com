...
But, before pushing your branch to the remote repository, always run the following two commands:

<pre class="sunlight-highlight-bash">git fetch origin
git rebase origin/master
</pre>

This applies your changes on top of the master branch making sure that there will be no conflicts when merging into master[1].
